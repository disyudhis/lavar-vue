<template>
  <aside class="w-64" aria-label="Sidebar">
    <div class="overflow-y-auto py-4 px-3 hidden bg-gray-50 rounded dark:bg-gray-800">
      <a href="" class="flex items-center pl-2.5 mb-5">
        <img src="../assets/WhatsApp_Image_2022-04-08_at_1.53.57_PM-removebg-preview.png" class="h-6 mr-3 sm:h-7" alt="Flowbite Logo" />
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Lavar</span>
      </a>
      <ul class="space-y-2">
        <li>
